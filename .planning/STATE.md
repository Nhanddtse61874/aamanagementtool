...
- 2026-07-12: **Execution mode: subagent-driven.** — Plan: `docs/superpowers/plans/2026-07-12-M8.1-core-extraction.md`. A fresh subagent per task, reviewed between tasks. Chosen specifically because M8.1 is a pure file move: an agent that does not carry this conversation's context cannot drift into "improving" the code it is only supposed to relocate.
