...
PRAGMA user_version = 6;");
    ...
    public async Task V6_to_v7_upgrade_adds_columns_and_tables_preserves_data_and_is_idempotent()
    {
        ...
        using (var c = _factory.Create())
        {
            // A v6 DB now upgrades all the way to the latest schema (v10) — the v7 step still runs
            // (adds the columns/tables below) and the later v8/v9/v10 steps run after it.
