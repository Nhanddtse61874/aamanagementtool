...
PRAGMA user_version = 7;");
    ...
    public async Task V7_to_v8_upgrade_adds_team_columns_and_tables_preserves_data_and_is_idempotent()
    {
        ...
        using (var c = _factory.Create())
        {
            // A v7 DB now upgrades all the way to the latest schema (v11) — the v8 step still runs
            // (adds the team columns/tables below) and the v9/v10/v11 steps run after it.
